...
-   `Query / Subscription <graphql_api_query>`{.interpreted-text
    role="ref"}
-   `Mutation <graphql_api_mutation>`{.interpreted-text role="ref"}

Batching operations
-------------------

The GraphQL API provides support for batched operations (which can be a
