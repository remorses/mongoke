...
or the cloud provider\'s native load balancer SSL termination features
to secure your API.
...
find more information at [Nginx
...
Caddy has SSL provisioning built-in with Let\'s Encrypt. You can find
the docs at [Caddy
website](https://caddyserver.com/docs/automatic-https).
