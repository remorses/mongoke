...
CLI](https://devcenter.heroku.com/articles/heroku-cli) to check the logs
...
-   <https://devcenter.heroku.com/articles/logging> for more details on
    logging on Heroku.
-   `hge_logs`{.interpreted-text role="ref"} for more details on Hasura
    logs
