...
-   If your **password contains special characters** (e.g. \#, %, \$, @,
    ...
    You can check the `logs <kubernetes_logs>`{.interpreted-text
    role="ref"} to see if the database credentials are proper and if
...
-   `Securing your GraphQL endpoint <kubernetes_secure>`{.interpreted-text
    role="ref"}
-   `GraphQL engine server logs <kubernetes_logs>`{.interpreted-text
    role="ref"}
-   `Updating GraphQL engine <kubernetes_update>`{.interpreted-text
    role="ref"}
