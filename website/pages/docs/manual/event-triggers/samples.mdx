...
Here\'s a [notification demo
app](https://serverless-push.demo.hasura.app/) showcasing sending web
...
Here\'s a [serverless ETL demo
app](https://serverless-etl.demo.hasura.app/) built using Hasura event
