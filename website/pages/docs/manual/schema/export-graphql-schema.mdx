...
Note that `apollo schema:download` is an alias of the command [apollo
service:download](https://github.com/apollographql/apollo-tooling#apollo-servicedownload-output).
