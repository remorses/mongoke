...
/img/graphql/manual/auth/auth-high-level-overview.png

As you can see from this:

-   **Authentication** is handled outside Hasura. Hasura delegates
...
-   For **Authorization** or **Access Control**, Hasura helps you define
    ...
    the actual query itself to validate the query against the rules
    defined by you. If the query/operation is allowed, it generates an
