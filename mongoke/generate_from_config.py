...
def generate_from_config(config, start=False):
    ...
    touch(
        f"{base}/generated/resolvers/support.py",
        populate_string(
            resolvers_support,
    ...
    touch(
        f"{base}/generated/sdl/general.graphql",
    ...
    for relation in relations:
        ...
        touch(
            f"{base}/generated/sdl/{fromType.lower()}_{relationName}.graphql",
            relation_sdl,
        )
        relation_template = (
            single_relation_resolver
        ...
        touch(
            f"{base}/generated/resolvers/{get_relation_filename(relation)}.py",
            relation_resolver,
        )
