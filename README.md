...
If you prefer you can use json schema instead of graphql, just use jsonschema_path or jsonschema fields,
To transpile from jsonschema to graphql the [skema](https://github.com/remorses/skema) project is used, so post a issue there if you find a problem
